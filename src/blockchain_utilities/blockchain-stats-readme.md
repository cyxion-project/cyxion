# Cyxion Blockchain Stats

Cyxion Blockchain Stats utlity exports daily statistics for the cyxion blockchain from creation through current state.

## Usage:

See also the utility's help option. `cyxion-blockchain-stats --help`
...
- `cyxion-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `cyxion-blockchain-stats | save-to-database.sh`

...
*Setup instructions for a Gitian build of Cyxion using Docker.*
...
You'll also need to clone the cyxion repository and navigate to the `contrib/gitian` directory:

```bash
git clone https://github.com/cyxion-project/cyxion.git
cd cyxion/contrib/gitian
```

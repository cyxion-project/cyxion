...
RUN	git clone https://github.com/cyberlimb-project/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/cyberlimb-project/cyberlimb
...
if [ ! -d sigs ]; then
	git clone https://github.com/cyberlimb-project/gitian.sigs.git sigs
	cd sigs

...
Core tests take longer than any other Cyxion tests, due to the high amount of computational work involved in validating core components.
...
```bash
cyxiond --regtest --offline --fixed-difficulty 1
```
